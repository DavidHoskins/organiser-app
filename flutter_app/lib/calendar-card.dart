...
class CalendarCard extends SmallCard
{
  ...
  CalendarCard(int index)
  {
    _getDateTime(index);
    leadingElement = FlutterLogo();
    titleElement = Text(_getDateString());
    pageRoute = MaterialPageRoute(builder: (context) => DatePage());
  }
